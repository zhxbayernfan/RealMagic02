#!/usr/bin/python3
"""Test MiniCPM-V 4.6 on original-003."""
...
image_path = os.path.join(work_dir, "original-003.")
...
output_file = os.path.join(work_dir, "original-003.")
with open(output_file, "w", encoding="utf-8") as f:
    f.write(f"Image: original-003.jpeg\nQuestion: {question}\nAnswer: {result}\n")
print(f"\n结果已保存到 original-003.")
