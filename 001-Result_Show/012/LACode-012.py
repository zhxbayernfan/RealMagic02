...
image_path = os.path.join(script_dir, "original-012.jpeg")
question = "Find all trees in the image."
label = "tree"
max_side = 1500
...
if boxes:
    ...
    output_path = os.path.join(script_dir, "LAResult-012.jpeg")
    orig_image.save(output_path, quality=95)
    print(f"Saved: {output_path}")
    print(f"Detected {len(boxes)} boxes, {len(unique_boxes)} unique")
else:
