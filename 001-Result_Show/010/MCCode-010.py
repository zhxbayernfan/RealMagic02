#!/usr/bin/python3
"""Test MiniCPM-V 4.6 on original-010."""
...
image_path = os.path.join(work_dir, "original-010.")
...
output_file = os.path.join(work_dir, "original-010.")
with open(output_file, "w", encoding="utf-8") as f:
    f.write(f"Image: original-010.jpg\nQuestion: {question}\nAnswer: {result}\n")
print(f"\n结果已保存到 original-010.")
