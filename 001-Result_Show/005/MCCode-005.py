#!/usr/bin/python3
"""Test MiniCPM-V 4.6 on original-005."""
...
image_path = os.path.join(work_dir, "original-005.")
...
output_file = os.path.join(work_dir, "original-005.")
with open(output_file, "w", encoding="utf-8") as f:
    f.write(f"Image: original-005.jpeg\nQuestion: {question}\nAnswer: {result}\n")
print(f"\n结果已保存到 original-005.")
