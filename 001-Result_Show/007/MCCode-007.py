#!/usr/bin/python3
"""Test MiniCPM-V 4.6 on original-007."""
...
image_path = os.path.join(work_dir, "original-007.")
...
output_file = os.path.join(work_dir, "original-007.")
with open(output_file, "w", encoding="utf-8") as f:
    f.write(f"Image: original-007.jpg\nQuestion: {question}\nAnswer: {result}\n")
print(f"\n结果已保存到 original-007.")
