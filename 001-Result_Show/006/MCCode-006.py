#!/usr/bin/python3
"""Test MiniCPM-V 4.6 on original-006."""
...
image_path = os.path.join(work_dir, "original-006.")
...
output_file = os.path.join(work_dir, "original-006.")
with open(output_file, "w", encoding="utf-8") as f:
    f.write(f"Image: original-006.jpg\nQuestion: {question}\nAnswer: {result}\n")
print(f"\n结果已保存到 original-006.")
