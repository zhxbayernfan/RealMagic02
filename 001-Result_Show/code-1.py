...
image_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "original-1.jpeg")
question = "Find all the cats in the image."  # 自然语言查询
...
if boxes:
    ...
    for i, (x1, y1, x2, y2) in enumerate(unique_boxes):
        ...
        draw.text((x1_orig, y1_orig - 25), "cat", fill=color, font=font)

    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "result-1.jpeg")
