...
class MydataDataset(GradSLAMDataset):
    def __init__(
        self,
        config_dict,
        basedir,
        ...
        desired_height: Optional[int] = 360,
    ...
    def get_filepaths(self):
        color_paths = natsorted(glob.glob(f"{self.input_folder}/rgb/*.jpg") + glob.glob(f"{self.input_folder}/rgb/*.png"))
    ...
    def load_poses(self):
        poses = []
        pose_files = natsorted(glob.glob(os.path.join(self.pose_path, "*.txt")))
